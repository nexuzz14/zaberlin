...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Zaberlin TV - Platform streaming video podcast, edukasi, variety show, dan iklan komersial terbaik Indonesia')">
    <title>@yield('title', 'Zaberlin TV') | Streaming Podcast, Edukasi & Hiburan</title>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><defs><linearGradient id='g' x1='0%25' y1='0%25' x2='100%25' y2='100%25'><stop offset='0%25' stop-color='%230E49B5'/><stop offset='100%25' stop-color='%23ED0101'/></linearGradient></defs><rect width='100' height='100' rx='20' fill='url(%23g)'/><path d='M38 28 v44 l36 -22 z' fill='white'/></svg>">
